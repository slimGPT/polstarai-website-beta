        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 gap-8 lg:gap-12 items-start lg:items-center">
            ...
            <div className="text-left">
              ...
              <div ref={buttonsRef} className="flex flex-col sm:flex-row items-center sm:items-center gap-4 sm:gap-6">
                <button
                ...
                <div className="hero-widget-column flex items-center justify-center">
                  <ElevenLabsWidget />
                </div>
              </div>
            </div>
