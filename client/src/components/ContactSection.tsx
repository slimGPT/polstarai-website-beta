...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-6 lg:py-8 bg-black overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
            ...
            {/* Right Side - Form */}
            <div ref={formRef} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 lg:p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-cyan-600 transition-all duration-200 shadow-lg shadow-blue-500/30"
                >
                  Book a Demo
                </button>
              </form>
