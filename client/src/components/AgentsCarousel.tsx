...
const agents: Agent[] = [
  {
    ...
    description: 'An emotional learning companion that adapts to tone, mood, and natural conversation.',
    ...
    <div className="relative w-full py-6 sm:py-8 lg:py-10">
        ...
        {agents.map((agent, index) => {
          ...
          return (
            <button
              ...
              onMouseEnter={() => !isActive && playHoverSound()}
              className={`px-6 py-2.5 rounded-full font-medium text-sm sm:text-base transition-all duration-300 relative ${
                isActive
      ...
      <div className="relative w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="absolute left-2 sm:left-4 md:left-6 top-1/2 -translate-y-1/2 z-20 w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-white/20 backdrop-blur-md border-2 border-white/40 flex items-center justify-center text-white hover:bg-white/30 hover:border-white/60 opacity-80 hover:opacity-100 transition-all duration-300 shadow-xl shadow-white/20"
        ...
        <button
          onClick={handleNext}
          onMouseEnter={playHoverSound}
          className="absolute right-2 sm:right-4 md:right-6 top-1/2 -translate-y-1/2 z-20 w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-white/20 backdrop-blur-md border-2 border-white/40 flex items-center justify-center text-white hover:bg-white/30 hover:border-white/60 opacity-80 hover:opacity-100 transition-all duration-300 shadow-xl shadow-white/20"
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <motion.button 
              ...
              className="group relative px-5 py-2 border border-white/30 text-white rounded-full hover:bg-white/10 hover:border-white/50 transition-all duration-300 text-sm overflow-hidden"
            >
