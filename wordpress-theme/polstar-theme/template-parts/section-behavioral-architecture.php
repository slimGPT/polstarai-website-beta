<?php
/**
 * Behavioral Architecture Section Template Part
 */
?>

<section id="behavioral-architecture" class="relative py-12 lg:py-16 bg-black overflow-hidden">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-6xl mx-auto">
            ...
            <p class="text-lg text-white/70 text-center max-w-3xl mx-auto">
                <!-- Add your behavioral architecture content here -->
            </p>
        </div>
    </div>
</section>
